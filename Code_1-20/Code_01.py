...
# Re-writing the same code with the use of string manipulation
# \n is use as the line breaker.
# Here + operator is used as the string concatenation. This joins multiple string together.
print("\n\n")
